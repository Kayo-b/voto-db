              ...
              >
                    ...
                    {votacao.proposicao && (
                      <div className="mb-3">
                        <div className="mb-1 flex items-center gap-3 flex-wrap">
                          ...
                          <a
                            href={`https://www.camara.leg.br/proposicoesWeb/fichadetramitacao?idProposicao=${votacao.proposicao.id}`}
                            target="_blank"
                            rel="noreferrer"
                ...
                {mostrarVotos[votacao.id] && votosDetalhados[votacao.id] && (
                  <div className="mt-4 border-t pt-4">
                    ...
                    {votosDetalhados[votacao.id].length === 0 ? (
                      <div className="rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-3 text-yellow-900">
                        Os votos desta votação não estão registrados na API do governo.
                      </div>
                    ) : (
                      <>
                        {/* Resumo */}
